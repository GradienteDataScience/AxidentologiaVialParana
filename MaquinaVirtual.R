...
# Transforma a transacción para pasarle a apriori()
tr6 <- as(Base2, "transactions")  # Convertir los datos a formato de transacción
itemFrequency(tr6)

# Obtener reglas con parámetros, Acá fijo STN=1 como consecuente 
...
# Transforma a transacción para pasarle a apriori()
tr4 <- as(Base, "transactions")  # Convertir los datos a formato de transacción
itemFrequency(tr4)
